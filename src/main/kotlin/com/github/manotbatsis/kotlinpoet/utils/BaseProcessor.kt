...
abstract class BaseProcessor : AbstractProcessor() {
    ...
    fun Element.getConstructorParameter(): VariableElement? {
        ...
        return if (enclosingElement is TypeElement)
            ElementFilter.constructorsIn(processingEnv.elementUtils.getAllMembers(enclosingElement))
                    .flatMap { it.parameters }
                    .filterNotNull()
    ...
    fun AnnotationMirror.findAnnotationValue(name: String): AnnotationValue?  =
                processingEnv.elementUtils.getElementValuesWithDefaults(this).keys
